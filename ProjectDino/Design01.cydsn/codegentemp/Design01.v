...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("b5c9c6f9-234e-4f31-9046-728d87f11ce7"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("ce9ee231-e6a0-47d4-bf50-00a42cc1e6f6"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    cy_annotation_universal_v1_0 Vdd_3 (
        .connect({
            Net_51
        })
    );
    defparam Vdd_3.comp_name = "Power_v1_0";
    defparam Vdd_3.port_names = "T1";
    defparam Vdd_3.width = 1;
	...
	cy_psoc3_pins_v1_10
		#(.id("94ab0d79-1cd1-4f70-a665-3a93bbdf2035"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("c89588fc-9496-4d70-b40d-7da25fe21846"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("271a0472-0863-419c-ba22-cec0c10b4954"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("3d2a6ca5-024f-4006-9d96-433184bedf3c"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
