...
module ADC_DelSig_v3_30_2 (
	...
	cy_clock_v1_0
		#(.id("59f8c4f8-11e4-44bd-b38c-98bfad0fdcbe/b7604721-db56-4477-98c2-8fae77869066"),
	...
	cy_clock_v1_0
		#(.id("59f8c4f8-11e4-44bd-b38c-98bfad0fdcbe/edd15f43-b66b-457b-be3a-5342345270c8"),
		  .source_clock_id("61737EF6-3B74-48f9-8B91-F7473A442AE7"),
		  .divisor(0),
		  .period("1562500000"),
		  .is_direct(0),
...
module CharLCD_v2_20_4 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("11871375-94c2-4d8e-863b-b63dfddedc55/ed092b9b-d398-4703-be89-cebf998501f6"),
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("933c63ae-c31a-4eef-89ac-a60a6dbf7618"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("01eea606-8163-4d6b-9ee4-af9c975fb641"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("c4c577d1-fb66-421e-83be-93510f819d6f"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("ecf9c8f1-b10a-40c4-ae05-d036b1923237"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    Timer_v2_80_1 Timer_keyboard_ISR (
        .capture(1'b0),
        .capture_out(Net_506),
        .clock(Net_456),
        .enable(1'b1),
        ...
        .tc(Net_508),
        .trigger(1'b1));
    defparam Timer_keyboard_ISR.CaptureCount = 2;
    defparam Timer_keyboard_ISR.CaptureCounterEnabled = 0;
    defparam Timer_keyboard_ISR.DeviceFamily = "PSoC5";
    defparam Timer_keyboard_ISR.InterruptOnCapture = 0;
    defparam Timer_keyboard_ISR.InterruptOnTC = 1;
    defparam Timer_keyboard_ISR.Resolution = 16;
    defparam Timer_keyboard_ISR.SiliconRevision = "0";
	...
	cy_clock_v1_0
		#(.id("2219ce63-9fa0-4e7b-992b-e1096936f1a0"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("1000000000"),
		  .is_direct(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("7a69d38f-dc13-43a0-9163-decedbb84aea"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("3810044f-7e7d-4fe9-b19c-52a93ba211dd"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("39f7ec49-cc99-431f-94c0-ad6ecc8cc07a"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    cy_annotation_universal_v1_0 PWR4 (
        .connect({
            Net_257
        })
    );
    defparam PWR4.comp_name = "Power_v1_0";
    defparam PWR4.port_names = "T1";
    defparam PWR4.width = 1;
    ...
    defparam R_9.comp_name = "Potentiometer_v1_0";
    defparam R_9.port_names = "T1, T2, W";
    defparam R_9.width = 3;
	...
	cy_clock_v1_0
		#(.id("6c756175-04d8-46bc-8e73-a34c05722f36"),
		  .source_clock_id("61737EF6-3B74-48f9-8B91-F7473A442AE7"),
		  .divisor(10),
		  .period("0"),
		  .is_direct(0),
	...
	wire [0:0] tmpOE__PWMOUT_net;
	wire [0:0] tmpFB_0__PWMOUT_net;
	wire [0:0] tmpIO_0__PWMOUT_net;
	wire [0:0] tmpINTERRUPT_0__PWMOUT_net;
	electrical [0:0] tmpSIOVREF__PWMOUT_net;

	cy_psoc3_pins_v1_10
		#(.id("6a20c22a-5c23-4871-b5f6-ed47c6fbca12"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		PWMOUT
		 (.oe(tmpOE__PWMOUT_net),
		  .y({Net_272}),
		  .fb({tmpFB_0__PWMOUT_net[0:0]}),
		  .io({tmpIO_0__PWMOUT_net[0:0]}),
		  .siovref(tmpSIOVREF__PWMOUT_net),
		  .interrupt({tmpINTERRUPT_0__PWMOUT_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PWMOUT_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    Timer_v2_80_6 MyTimer (
        ...
        .tc(Net_318),
        .trigger(1'b1));
    defparam MyTimer.CaptureCount = 2;
    defparam MyTimer.CaptureCounterEnabled = 0;
    defparam MyTimer.DeviceFamily = "PSoC5";
    defparam MyTimer.InterruptOnCapture = 0;
    defparam MyTimer.InterruptOnTC = 0;
    defparam MyTimer.Resolution = 16;
    defparam MyTimer.SiliconRevision = "0";
	...
	cy_psoc3_pins_v1_10
		#(.id("e837a915-f3e5-4a9a-8eba-c9e62dd93fd9"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("0627ea0b-7b6a-4179-b4d7-67d4c6efd704"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("c84f6ba0-1934-4984-a562-2822da6c257e"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("596ec7f6-f80d-43ac-b6ca-8ca9394fb72e"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("8f9009cd-97ef-44e0-87d2-0c73afb16ecc"),
		  .drive_mode(3'b100),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("a41e55c6-abd1-4985-b24d-b6d79e5ed581"),
		  .drive_mode(3'b100),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("516d67d1-8b21-46c1-a70f-c43666d16d9a"),
		  .drive_mode(3'b100),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
